...
//how do you create HTML elements?
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            null,
            time.getUTCFullYear() + ':' + time.getUTCMonth() + ':' + time.getUTCDate() + ':' + time.getHours() + ':' + time.getMinutes() + ':' + time.getSeconds()
          )
        )
      );
    }
...
var Tabs = function (_React$Component) {
  ...
  function Tabs(props) {
    ...
    _this.state = { tabs: props.tabs, selected: 0 };
    return _this;
  }
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var tabHeader = this.state.tabs.map(function (el, idx) {
        return _react2.default.createElement(
          'li',
          { id: idx, key: idx, onClick: _this2.toggleActiveClass, className: idx === _this2.state.selected ? "tabHeaderActive" : "" },
          _react2.default.createElement(
            'h1',
            null,
            el.title
      ...
      var tabBodies = this.state.tabs.map(function (el, idx) {
        return _react2.default.createElement(
          'li',
          { id: idx, key: idx, className: idx === _this2.state.selected ? "tabBodiesActive" : "" },
          _react2.default.createElement(
            'article',
            null,
            el.content
...
var tabProp = [{ title: 'first', content: "i am the first" }, { title: "second", content: "i am the second" }, { title: "third", content: "i am the third" }];
...
var Root = function Root() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_tabs2.default, { tabs: tabProp }),
...
var Weather = function (_React$Component) {
  ...
  function Weather(props) {
    ...
    _this.state = { location: null, weather: null };
    _this.getWeather = _this.getWeather.bind(_this);
    navigator.geolocation.getCurrentPosition(function (position) {
      _this.setState({ location: position });
      _this.getWeather();
    });
    return _this;
  }
      ...
      if (this.state.weather) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h1',
            null,
            Math.round(this.state.weather.main.temp - 273),
            ' Centigrade'
          )
        );
      } else {
